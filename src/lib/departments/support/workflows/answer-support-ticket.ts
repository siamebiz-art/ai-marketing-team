...
import type { SupportCategorizerOutput } from '@/lib/departments/support/prompts/support-categorizer.prompts'
...
// loadBrandContext/BrandContext (product info + brand voice are just as relevant
