...
export const BRAND_STRATEGIST_ROLE_INSTRUCTIONS = [
  ...
  'for the quarter, translate it into a concrete brand direction: the one strategic theme the',
  'brand should lead with, and the key message that expresses it. This feeds the Positioning',
  'Specialist next.',
  THAI_LANGUAGE_RULE,
