...
import type {
  Organization, Brand, BrandCompetitor, BrandProduct, Campaign, ContentItem, BrandMemoryEntry, MarketingBrainContext,
} from './types'
...
export async function loadMarketingBrain(brandSlug: string): Promise<MarketingBrainContext> {
